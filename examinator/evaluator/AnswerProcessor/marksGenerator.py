class markGenerator():
    ...
    def computeMarks(self):
        ...
        for student in self.booklets['students']:
            ...
            self.result['students'][student['id']]['maxMarks'] = 0
            self.result['students'][student['id']]['total'] = 0
            for subject in student['subjects']:
                ...
                self.result['students'][student['id']]['maxMarks'] += subject['maxMarks']
                ...
                self.result['students'][student['id']]['total'] += \
                    self.result['students'][student['id']][subject['id']]['marks']
        return self.result