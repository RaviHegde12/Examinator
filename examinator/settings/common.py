...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'nimi!4xx9+^n7&w8p6255v1g54qo3q4qhee*v@8ywulabh*uk9')
...
# See .ebextensions/Examinator.config
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'when': 'midnight',
            'backupCount': 10,
            'filename': os.path.join(LOG_DIR, 'examinator.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
